        ...
        <div>
            {
                ...
                <div className='relative'>
                    ...
                    <aside id="default-sidebar" className={`fixed top-20 left-1 z-40 w-64 h-[88vh] transition-transform -translate-x-full md:translate-x-0 ${ShowSidebar ? "translate-x-0" : ""} `} aria-label="Sidebar">
