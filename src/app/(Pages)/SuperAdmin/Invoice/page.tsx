...
import { Search, X, AlertCircle, Star, Trash2 } from 'lucide-react';
        ...
        <div className="h-screen flex flex-col">
            ...
            <div className="mb-4 bg-white rounded-lg shadow-sm p-4">
                ...
                {selectedInvoices.length > 0 && (
                    <div className="mt-3 flex items-center justify-between bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm flex items-center gap-2"
                            >
                            ...
                            <button
                                ...
                                disabled={isProcessing || isDeleting}
                                className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm flex items-center gap-2"
                            >
                                ...
                                displayedInvoices.map((invoice: Invoice, i: number) => (
                                    <tr key={invoice._id} className={`hover:bg-gray-50 transition-colors ${selectedInvoices.includes(invoice._id) ? 'bg-blue-50' : ''}`}>
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                                            ...
                                            {
                                                invoice.delete && <span title="Deleted Invoice" className="ml-1 text-red-500">
                                                    🗑
                                                </span>
                                            }
                                        </td>
